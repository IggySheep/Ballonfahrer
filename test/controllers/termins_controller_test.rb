...
class TerminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create termin" do
    assert_difference('Termin.count') do
      post termins_url, params: { termin: { beschreibung: @termin.beschreibung, datum: @termin.datum, koch: @termin.koch, title: @termin.title, uhrzeit: @termin.uhrzeit } }
    end
  ...
  test "should update termin" do
    patch termin_url(@termin), params: { termin: { beschreibung: @termin.beschreibung, datum: @termin.datum, koch: @termin.koch, title: @termin.title, uhrzeit: @termin.uhrzeit } }
